...
const CompanyListCard = ({ company }) => {
  return (
    ...
    <div className='border w-230 h-27 m-4 rounded-sm shadow-md flex wrap hover:shadow-lg border-blue-700 items-center hover:scale-105 transition-all duration-300 relative'>
